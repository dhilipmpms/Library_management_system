...
urlpatterns = [
    ...
    path("sub_cat_1", views.sub_cat_1, name="sub_cat_1"),
    path("sub_cat_2", views.sub_cat_2, name="sub_cat_2"),
    path("sub_cat_3", views.sub_cat_3, name="sub_cat_3"),
    path("sub_cat_4", views.sub_cat_4, name="sub_cat_4"),
    path("sub_cat_5", views.sub_cat_5, name="sub_cat_5"),
    path("sub_cat_6", views.sub_cat_6, name="sub_cat_6"),
    path("sub_cat_7", views.sub_cat_7, name="sub_cat_7"),
    path("sub_cat_8", views.sub_cat_8, name="sub_cat_8"),
    path("sub_cat_9", views.sub_cat_9, name="sub_cat_9"),
    ...
    path('staffs/save/', views.save_staff, name='save-staff'),
    path('staffs/view/<int:pk>/', views.view_staff, name='view-staff-pk'),
    path('staffs/manage/<int:pk>/', views.manage_staff, name='manage-staff-pk'),
    path('staffs/manage/', views.manage_staff, name='manage-staff'),
    path('staffs/delete/<int:pk>/', views.delete_staff, name='delete-staff'),
    ...
    path("staff_borrows", views.staff_borrows, name="staff-borrow-page"),
    path("manage_staff_borrow", views.manage_staff_borrow, name="manage-staff-borrow"),
    path("manage_staff_borrow/<int:pk>", views.manage_staff_borrow, name="manage-staff-borrow-pk"),
    path("view_staff_borrow/<int:pk>", views.view_staff_borrow, name="view-staff-borrow-pk"),
    path("save_staff_borrow", views.save_staff_borrow, name="save-staff-borrow"),
    path("delete_staff_borrow/<int:pk>", views.delete_staff_borrow, name="delete-staff-borrow-pk"),
