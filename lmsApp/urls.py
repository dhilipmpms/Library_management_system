...
urlpatterns = [
    ...
    path(
        "manage_sub_category/<int:pk>",
        views.manage_sub_category,
        name="manage-sub_category-pk",
    ),
    path(
        "view_sub_category/<int:pk>",
        views.view_sub_category,
        name="view-sub_category-pk",
    ),
    path("save_sub_category", views.save_sub_category, name="save-sub_category"),
    path(
        "delete_sub_category/<int:pk>",
        views.delete_sub_category,
        name="delete-sub_category",
    ),
